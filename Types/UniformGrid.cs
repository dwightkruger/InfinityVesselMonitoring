...
/// <summary>
/// Port of WPF UniformGrid control to UWP. In the Microsoft UWP examples on GitHub, see the XamlUIBasics project. 
/// They have a custom WrapPanel included in the project. I took that code and combined it with a reverse compile 
/// of the the WPF UniformGrid control to get the code below.
/// 
/// January 20, 2016
/// RickApps.com
/// </summary>
namespace InfinityGroup.VesselMonitoring.Types
{
    ...
    public class UniformGrid : Panel
    {
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            double width = ((FrameworkElement)Parent).ActualWidth;
            double height = ((FrameworkElement)Parent).ActualHeight;

            if (this.HorizontalAlignment != HorizontalAlignment.Stretch || 0 == width)
            {
                width = num * (double)this._columns;
            }

            if (this.VerticalAlignment != VerticalAlignment.Stretch || 0 == height)
            {
                height = num2 * (double)this._rows;
            }
        ...
        /// <summary>
        /// Defines the layout of the System.Windows.Controls.Primitives.UniformGrid by distributing space evenly 
        /// among all of the child elements.
        /// </summary>
