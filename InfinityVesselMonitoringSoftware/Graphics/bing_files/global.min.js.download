...
var loc = {
    ...
    "disable": "Disable",
    "disclaimer.archive": "We're no longer updating this content regularly, but the product, service, or technology is still supported.",
            ...
            for (var i = 0; i < json.length; i++) {
                if (json[i].href) {
                    ...
                    if (checkThisIsMe && json[i].href.length) {
                        hrefNoQuery = removeQueryString(removeLocaleFromPath(json[i].href.toLowerCase()));
...
var productionOAuthUrl = 'https://docsgithuboauth.azurewebsites.net';
